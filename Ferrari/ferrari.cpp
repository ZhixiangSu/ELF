...
int main(int argc, char *argv[]) {
  ...
  unsigned ELF_space = g->num_nodes();
  /// 
  
  //std::cout << "Index Size: " << interval_space + seed_space + idspace + filter_space
  //          << " bytes" << std::endl;
  std::cout << "Index Size: " << float(interval_space + seed_space + idspace + filter_space+ELF_space) / 1024
      << " KB" << std::endl;
  /// 
